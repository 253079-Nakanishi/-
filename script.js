function showResult() {
  ...
  const results = [
    ...
    {min: 15, max: 15, title: "【Clean Core】🧹お風呂・お掃除・きれい好き♪", description: "真面目な性格のあなたには、Clean Core（クリーンコア）がおすすめ！このインターネット美学は、洗剤やスポンジなど掃除に関するアイテムを取り入れた、爽やかで清潔なジャンルです。すっきりしたデザインの中に、黄色やピンク色などを取り入れて、楽しさも表現していたりします。なんだか、心まで浄化されそうなジャンルですね…✨", images: ["img1D.png","img2D.png","img3D.png"]},
    
    {min: 16, max: 16, title: "【Arcade Core】👾気分はアーケードゲーマー！", description: "陽気で楽しいことが大好きなあなたには、Arcade Core（アーケードコア）がおすすめ！このインターネット美学は、名前の通り、アーケードゲームから着想を得たジャンルです。薄暗い店内に光るネオンとゲーム画面…見ているだけでもワクワクしてきますね！ファッション方面でも発達しており、ゲームの世界に飛び込んだような、ポップでカジュアルなコーデが楽しめます♪", images: ["img1D.png","img2D.png","img3D.png"]},
    
    {min: 17, max: 17, title: "【McBling】🦩ホットピンクは私のものよ", description: "自分らしくありたいと願うあなたには、McBling（マックブリング）がおすすめ！このインターネット美学は、2000年代アメリカのセレブの着こなしから着想を得たジャンルです。きらびやかでド派手なショッキングピンクや、ヒョウ柄のアイテムを取り入れて、いつもと違う自分に出会ってみるのもアリかもしれません✨", images: ["img1E.png","img2E.png","img3E.png"]},
    
    {min: 18, max: 18, title: "【Kid Core】🪁忘れたくない幼少期", description: "少年の心を忘れないあなたには、Kid Core（キッドコア）がおすすめ！このインターネット美学は、幼少期を連想させる、カラフルなおもちゃやファッションを扱うジャンルです。虹色のクレヨンやパズル、ビーズのブレスレットなど、懐かしい気分に浸れるアイテムがてんこ盛り！何歳になっても、素敵なものは素敵に映るんですね…✨", images: ["img1E.png","img2E.png","img3E.png"]},
    
    {min: 19, max: 19, title: "【Liminal Space】🚪あなたは来訪者に選ばれました", description: "一人の時間を愛するあなたには、Liminal Space（リミナルスペース）がおすすめ！このインターネット美学は、「人で賑わっているはずなのに誰もいない…」「明るいはずなのに真っ暗…」そんな違和感が織りなす異質な雰囲気、そこから生まれる不安と安心感が入り混じったような、不思議な感覚が味わえるジャンルです。こんな空間に迷いこんだらどうしよう…そこにあるのは孤独？それともワクワク？", images: ["img1D.png","img2D.png","img3D.png"]},
    
    {min: 20, max: 20, title: "【Frutiger Metro】🪇気分は音楽フェス！", description: "いつだって楽しむことを忘れないあなたには、Frutiger Metro（フルティガーメトロ）がおすすめ！このインターネット美学は、2000～2010年代のポスターやパッケージのデザインから着想を得ており、円や曲線、鮮やかな色使いがポイントのジャンルです。音符やスピーカーなど、音楽的なモチーフもよく取り入れられ、賑やかでテンションが上がるスタイルになっています♪", images: ["img1E.png","img2E.png","img3E.png"]},
    
       {min: 21, max: 21, title: "【Internet Awesome Sauce】🖥️インターネットSUGEEEEEEE!!!!!", description: "面白い話題が大好きなあなたには、Internet Awesome Sauce（インターネット オーサムソース）がおすすめ！このインターネット美学は、2000～2010年代にネット上で流行した、おもしろおかしい、そしてシュールなネタを扱うジャンルです。猫が宇宙を飛んでいたり、目からビームを出していたり…このハチャメチャ具合が最大のアピールポイントです。", images: ["img1B.png","img2B.png","img3B.png"]},
    
    {min: 22, max: 22, title: "【Dream Core】💤夢？現実？不思議な世界", description: "夢見がちな性格のあなたには、Dream Core（ドリームコア）がおすすめ！このインターネット美学は、夢の中にいるような不安定な感覚と、幼少期のぼんやりした記憶のような雰囲気が魅力的です。この絶妙なバランスの中に、自分だけが見ている夢ならではの安心感や、ワクワクする冒険心を見出す人も多し！", images: ["img1C.png","img2C.png","img3C.png"]},
    
      {min: 23, max: 24, title: "【Frutevil Aero】🔥希望の裏に抱えた地獄", description: "刺激に飢えているあなたには、Frutevil Aero（フルテビルエアロ）がおすすめ！このインターネット美学は、未来への希望を表現したFrutiger Aero（フルティガーエアロ）とは正反対の、地獄のようなビジュアルが特徴的なジャンルです。これを壁紙やLINEの背景に使えば、周囲から一目置かれること間違いなし…！！", images: ["img1C.png","img2C.png","img3C.png"]},
  ];
