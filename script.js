function showResult() {
  ...
  const results = [
   ...
   {min: 18, max: 18, title: "【Kid Core】🪁忘れたくない幼少期", description: "少年の心を忘れないあなたには、Kid Core（キッドコア）がおすすめ！このインターネット美学は、子供時代を連想させる、カラフルなおもちゃやファッションを扱うジャンルです。虹色のクレヨンやシール、ビーズのブレスレットなど、懐かしい気分に浸れるアイテムがてんこ盛り！何歳になっても、素敵なものは素敵に映るんですね✨", images: ["https://i.pinimg.com/originals/df/76/a0/df76a0bfe095cfeae9bb65f616bb31f8.png","https://styles.redditmedia.com/t5_bsy6pj/styles/communityIcon_6jx5sbvcx88d1.png","https://wallpapers.com/images/hd/kidcore-pictures-gshn0ju6wxme9p3m.jpg"]},
